...
public class TexteTest {
	...
	public void testDescription() {
		assertEquals("Texte centre=192.0,128.0 taille=64 texte=Istic L2GEN couleur=black", texte.description(0));
	}

	@Test
	public void testDescription2() {
		assertEquals("  Texte centre=0.0,0.0 taille=0 texte= couleur=black", texteVide.description(1));
	}
	...
	public void testDescription3() {
		...
		texte.colorier("red");
		assertEquals("Texte centre=192.0,128.0 taille=64 texte=Istic L2GEN couleur=red", texte.description(0));
	}
	...
	public void testEnSVG() {
		assertEquals(
				"<text x=\"192.0\" y=\"128.0\" font-size=\"64\" text-anchor=\"middle\" fill=\"black\" stroke=\"black\">Istic L2GEN</text>",
				texte.enSVG());
	}
	...
	public void testEnSVG2() {// avec changement de couleur
		texte.colorier("red");
		assertEquals(
				"<text x=\"192.0\" y=\"128.0\" font-size=\"64\" text-anchor=\"middle\" fill=\"red\" stroke=\"black\">Istic L2GEN</text>",
				texte.enSVG());
	}
	...
	public void testEnSVG3() {
		assertEquals(
				"<text x=\"0.0\" y=\"0.0\" font-size=\"0\" text-anchor=\"middle\" fill=\"black\" stroke=\"black\"></text>",
				texteVide.enSVG());
	}
