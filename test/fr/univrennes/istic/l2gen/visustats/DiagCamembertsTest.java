...
public class DiagCamembertsTest {
    ...
    /* Ce test est commenté car la valeur attendue est trop longue pour être écrite dans le test */
    /*@Test
    ...
    public void testHauteur() {
        assertEquals(200.0, diagCamembert.hauteur(), 0.0001);
    }
    ...
    public void testRedimmensioner() {
        ...
        assertEquals(10, diagCamembert.hauteur(), 0.0001);
    }
