...
public class Accueil {
    ...
    public Accueil() {
        ...
        // Onglet onglets = new Onglet("Acceuil", "Stat", (int)
        // tailleUtilisable.getWidth(),
        // (int) tailleUtilisable.getHeight());
        // fenetre.add(onglets.GetPanel());
        fenetre.setSize((int) tailleUtilisable.getWidth(), (int) tailleUtilisable.getHeight());
