...
public interface IForme {
    ...
    /**
     * Retourne une description de la forme géométrique, avec une indentation spécifiée.
     *
     ...
     * @return Une référence à l'instance de la forme géométrique, pour permettre les opérations en chaîne.
     */
     ...
     *
     * @return Une nouvelle instance de la forme géométrique avec les mêmes propriétés.
     */
     ...
     *
     * @return Une chaîne de caractères représentant la forme géométrique en format SVG.
     */
    public String enSVG();
